...
public class ChooseRankingsModeScene extends PixelScene {

	private static final float BUTTON_HEIGHT	= 24;

	private static final String TXT_VIEW_RANKINGS		= "View Rankings";
	...
	public void create() {
		...
		btnPlay = new ViewButton( TXT_VIEW_RANKINGS ) {
			@Override
		...
		Rankings.Record lastRecord = Rankings.INSTANCE.getLastRecord();
		updateMode(lastRecord != null ? lastRecord.gamemode : modes[0]);
		...
		Badges.loadingListener = new Callback() {
			@Override
			public void call() {
				if (Game.scene() == ChooseRankingsModeScene.this) {
	...
	private static class ViewButton extends RedButton {
		...
		public ViewButton( String primary ) {
			super( primary );
