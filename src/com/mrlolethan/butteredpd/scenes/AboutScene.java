...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		final float colWidth = Camera.main.width / (ButteredPixelDungeon.landscape() ? 2 : 1);
		final float colTop = (Camera.main.height / 2) - (ButteredPixelDungeon.landscape() ? 30 : 90);
		final float wataOffset = ButteredPixelDungeon.landscape() ? colWidth : 0;
		...
		wata.y = align( ButteredPixelDungeon.landscape() ?
						colTop:
