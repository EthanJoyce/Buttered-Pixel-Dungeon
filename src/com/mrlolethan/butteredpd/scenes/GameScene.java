...
import com.mrlolethan.butteredpd.FogOfWar;
...
import com.mrlolethan.butteredpd.sprites.DiscardedItemSprite;
...
import com.mrlolethan.butteredpd.ui.AttackIndicator;
import com.mrlolethan.butteredpd.ui.Banner;
import com.mrlolethan.butteredpd.ui.BusyIndicator;
import com.mrlolethan.butteredpd.ui.GameLog;
import com.mrlolethan.butteredpd.ui.HealthIndicator;
import com.mrlolethan.butteredpd.ui.LootIndicator;
import com.mrlolethan.butteredpd.ui.QuickSlotButton;
import com.mrlolethan.butteredpd.ui.ResumeIndicator;
import com.mrlolethan.butteredpd.ui.StatusPane;
import com.mrlolethan.butteredpd.ui.Toast;
...
import com.mrlolethan.butteredpd.windows.WndBag.Mode;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		ButteredPixelDungeon.lastGameMode(Dungeon.gamemode.ordinal());
		ButteredPixelDungeon.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + ButteredPixelDungeon.zoom(), maxZoom));
		...
		brightness( ButteredPixelDungeon.brightness() );
